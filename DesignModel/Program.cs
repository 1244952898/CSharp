...
namespace DesignModel
{
    internal class Program
    {
        ...
        19.中介者模式：使用一个中介对象来封装一系列的对象交互。中介者使对象不需要显示地相互引用。从而使其耦合松散，并可以独立的改变他们之间的交互

        20.享元模式：运用共享技术有效的支持大量细粒度的对象交互

        21.解释器模式：定义一种语言，定义它的文法的一种表示，并定义一个解释器这个解释器使用该表示来解释语言中的句子
